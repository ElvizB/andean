...
<div id="carousel-example-2" class="carousel slide carousel-fade z-depth-3" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
            <div class="view">
                <img class="d-block w-100" src="<?php echo RUTA_IMG?>slider/banner_2.png" alt="Second slide">
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="<?php echo RUTA_IMG?>slider/banner_4.png" alt="Third slide">
            </div>
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="<?php echo RUTA_IMG?>slider/banner_1.png" alt="First slide">
            </div>
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100" src="<?php echo RUTA_IMG?>slider/banner_3.png" alt="Third slide">
            </div>
        </div>
    </div>
    <!--/.Slides-->
...
<div class="container ">
    ...
    <div class="text-center py-4 title-home">
        ...
        <p class="class py-3 wow fadeInUp text-justify text-md-center" data-wow-delay="0.7s">
            <?php echo $descripcionInicio; ?></p>
