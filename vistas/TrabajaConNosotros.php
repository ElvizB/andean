...
<div class="pt-5 pb-5">
  ...
  <div class="container">
    ...
    <div>
      ...
      <h1 class="h1-responsive font-weight-bold text-center wow fadeInUp" data-wow-delay="0.3s"  key="t_descrip2"><strong><?php echo $t_descrip2; ?></strong></h1>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 mb-lg-0 mb-4">
          ...
          <div class="wow fadeInUp" data-wow-delay="0.3s" >                
            <h1 class="h1-responsive font-weight-bold text-center white-text" style="border-bottom: 2px solid white;"><?php echo $t_descrip3; ?></h1>
