        ...
        <div class="row text-center wow fadeInUp">
            ...
            <div class="col-md-3 mb-md-0 mb-5">
                ...
                <div class="testimonial">
                    ...
                    <p class="dark-text">
                        <a href="mailto:incoming@andean-tours.com" target="_parent"
                            style="text-decoration:none;color: #595959;">incoming@andean-tours.com</a>
                        <a href="mailto:contacto@andean-tours.com" target="_parent"
                            style="text-decoration:none;color: #595959;">contacto@andean-tours.com</a>
                    </p>
                    <!--Review-->
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="testimonial">
                    ...
                    <p class="lang dark-text">
                        <a href="http://www.andean-tours.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 mb-lg-0 mb-4">
                    ...
                    <div class=" wow fadeInUp title-contacto" data-wow-delay="0.1s">
                        <h1 class="h1-responsive "><?php echo $c_titulo; ?></h1>
                        <hr />
                        <h5 class="h1-responsive "><?php echo $c_subtitulo; ?></h5>
