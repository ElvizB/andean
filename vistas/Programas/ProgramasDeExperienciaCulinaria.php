...
<div>
  ...
  <div class="pt-5 pb-4">
    <div class="container">
      <div>
        <h1 class="h1-responsive font-weight-bold text-center pt-4 wow fadeInUp" data-wow-delay="0.1s"><strong><?php echo $p_g_title; ?></strong></h1>
        <p class="text-justify text-md-center py-3 wow fadeInUp" data-wow-delay="0.3s"><?php echo $p_l_subtitle; ?></p>         
      </div>
      <!-- Grid row -->
      <div class="row">
          ...
          <div class="card wow zoomIn" data-wow-delay="0.1s">
            ...
            <div class="d-flex flex-row">
              <div class="w-80 fondo-secundary">
                <div class="card-body">
                  <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content; ?></p>
                  <!--Text-->
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
          ...
          <div class="card wow zoomIn" data-wow-delay="0.1s">
            ...
            <div class="d-flex flex-row">
              <div class="w-80 fondo-secundary">
                <div class="card-body">
                  <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content2; ?></p>
                  <!--Text-->
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
          ...
          <div class="card wow zoomIn" data-wow-delay="0.1s">
            ...
            <div class="waves-effect waves-light zoom" style="cursor: auto;">
              ...
              <div class="fondo_ha">
                <span class="lang white-text font-weight-bold" key="p_g_ex2"><?php echo $p_g_ex2; ?></span>
              </div>
              <div class="fondo3 fondo_day_descrip">
                <span class="lang white-text font-weight-bold" key="p_g_tar_day3"><?php echo $p_g_tar_day3; ?></span>
              </div>
            </div>
            <!--Card content-->
            <div class="card-body fondo3">
              ...
              <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title3; ?></h6>
            ...
            <div class="d-flex flex-row">
              <div class="w-80 fondo-secundary">
                <div class="card-body">
                  <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content3; ?></p>
                  <!--Text-->
                </div>
  ...
  <div>
    ...
    <div class="pt-5 pb-4">
      <div class="container">
        ...
        <div class="pb-4">
          <h1 class="h1-responsive font-weight-bold wow fadeInUp" data-wow-delay="0.3s"><strong><?php echo $p_g_des; ?></strong></h1>  
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="card-body fondo4">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title4; ?></h6>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content4; ?></p>
                    <!--Text-->
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="card-body fondo5">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title5; ?></h6>
                <span class="card-title white-text p_subtitulo">Lima</span>
                <!--Text-->
              </div>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content5; ?></p>
                    <!--Text-->
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="card-body fondo6">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title6; ?></h6>
                <span class="card-title white-text p_subtitulo">Lima</span>
                <!--Text-->
              </div>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content6; ?></p>
                    <!--Text-->
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="card-body fondo7">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title7; ?></h6>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content7; ?></p>
                    <!--Text-->
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="card-body fondo8">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title8; ?></h6>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content8; ?></p>
                    <!--Text-->
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
            ...
            <div class="card wow zoomIn" data-wow-delay="0.1s">
              ...
              <div class="waves-effect waves-light zoom" style="cursor: auto;">
                ...
                <div class="fondo_ha">
                  <span class="lang white-text font-weight-bold" key="p_g_hacienda"><?php echo $p_g_hacienda; ?></span>
                </div>
              ...
              <div class="card-body fondo9">
                ...
                <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_g_tar_title9; ?></h6>
              ...
              <div class="d-flex flex-row">
                <div class="w-80 fondo-secundary">
                  <div class="card-body">
                    <p class="card-title white-text text-justify p_descrip"><?php echo $p_g_tar_content9; ?></p>
                    <!--Text-->
                  </div>
