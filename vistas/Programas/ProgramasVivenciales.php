...
<div class="pt-5 pb-4">
    <div class="container">
        <div class="u-title-programs">
            ...
            <p class="wow fadeInUp" data-wow-delay="0.3s"><?php echo $p_v_subtitle; ?>
            </p>
        </div>
        <!-- Grid row -->
        <div class="row">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content; ?>
                                </p>
                                <!--Text-->
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content2; ?>
                                </p>
                                <!--Text-->
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content3; ?>
                                </p>
                                <!--Text-->
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content4; ?>
                                </p>
                                <!--Text-->
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content5; ?>
                                </p>
                                <!--Text-->
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
                ...
                <div class="card wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex flex-row">
                        <div class="w-80 fondo-secundary">
                            <div class="card-body">
                                <p class="card-title white-text text-justify p_descrip"><?php echo $p_v_tar_content6; ?>
                                </p>
                                <!--Text-->
                            </div>
