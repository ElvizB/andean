...
<div class="pt-5 pb-4">
  <div class="container">
    <div>
      <h1 class="h1-responsive font-weight-bold text-center pt-4 wow fadeInUp" data-wow-delay="0.1s"><strong><?php echo $p_av_title; ?></strong></h1>
      <p class="text-justify text-md-center py-3 wow fadeInUp" data-wow-delay="0.3s"><?php echo $p_av_subtitle;?><br><?php echo $p_av_subtitle2;?> </p>         
    </div>
    <!-- Grid row -->
    <div class="row">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content2; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content3; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content4; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content5; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content6; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content7; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content8; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content9; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="card-body fondo10">
            ...
            <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_av_tar_title10; ?></h6>
            <span class="card-title white-text p_subtitulo">Cusco</span>
            <!--Text-->
          </div>
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content10; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="card-body fondo11">
            ...
            <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_av_tar_title11; ?></h6>
            <span class="card-title white-text p_subtitulo">Cusco</span>
            <!--Text-->
          </div>
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content11; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="card-body fondo12">
            ...
            <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_av_tar_title12; ?></h6>
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content12; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="card-body fondo13">
            ...
            <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_av_tar_title13; ?></h6>
            <span class="card-title white-text p_subtitulo">Cusco</span>
            <!--Text-->
          </div>
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content13; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content14; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content15; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content16; ?></p>
                <!--Text-->
              </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 pb-5">
        ...
        <div class="card wow zoomIn" data-wow-delay="0.2s">
          ...
          <div class="card-body fondo17">
            ...
            <h6 class="card-title white-text font-weight-bold p_titulo"><?php echo $p_av_tar_title17; ?></h6>
            <span class="card-title white-text p_subtitulo">Cusco</span>
            <!--Text-->
          </div>
          ...
          <div class="d-flex flex-row">
            <div class="w-80 fondo-secundary">
              <div class="card-body">
                <p class="card-title white-text text-justify p_descrip"><?php echo $p_av_tar_content17; ?></p>
                <!--Text-->
              </div>
