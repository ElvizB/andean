  ...
  <section class="my-5">
    <div class="row">
      ...
      <div class="col-lg-6 mb-lg-0 mb-4">
        ...
        <p class="responsive pb-2 text-justify wow fadeInUp" data-wow-delay="0.1s" style="font-size: 18px;"> <?php echo $n_desc1; ?></p>

        <p class="responsive pb-2 font-weight-bold wow fadeInUp" data-wow-delay="0.3s" style="font-size: 18px;"><?php echo $n_desc2; ?></p>
...
<div id="nosotros">
  ...
  <div class="container">
    ...
    <section class="team-section text-center my-5">
      ...
      <!-- Section heading -->
      <h2 class="h2-responsive font-weight-bold my-5 white-text wow fadeInUp" data-wow-delay="0.2s"><?php echo $n_titulo; ?></h2>
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 mb-md-0 mb-5 ">
        ...
        <div class="testimonial">
          ...
          <!--Content-->
          <p class="dark-text mt-4 text-justify wow fadeInUp" data-wow-delay="0.3s"><?php echo $n_desc_vision; ?></p>
          <!--Review-->
        </div>
      ...
      <div class="col-md-4 mb-md-0 mb-5">
        ...
        <div class="testimonial">
          ...
          <!--Content-->
          <p class="dark-text mt-4 text-justify wow fadeInUp" data-wow-delay="0.5s"><?php echo $n_desc_mision; ?></p>
          <!--Review-->
        </div>
